...
function loadListTieubanPhancong(){
    xhttp.open("GET", "/api/danhsachtieubanphancong?page="+page_num+"&MaGV="+MaGV, false);
    xhttp.send();
}

function loadlistChamdiemTieuban(){
    xhttp.open("GET", "/api/danhsach-chamdiem-tieuban?page="+page_num+"&MaGV="+MaGV+"&MaTB="+MaTB, false);
    xhttp.send();
}
